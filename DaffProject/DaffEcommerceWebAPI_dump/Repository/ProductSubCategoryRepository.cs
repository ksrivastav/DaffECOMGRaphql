...
namespace DaffEcommerceProductService.Repository
{
    public class ProductSubCategoryRepository : IProductSubCategoryRepository<ProductSubCategory>
    {
        ...
        public async Task<ProductSubCategory> getSingleItem(long id)
        {
            ...
            ProductSubCategory = await _dbContext.ProductSubCategory.FirstAsync(x => x.ProductSubCategoryId == id);
        ...
        public async Task<ProductSubCategory> updateSingleItem(ProductSubCategory ProductSubCategory)
        {
            ...
            try
            {
                ...
                updatedProductSubCategory = await _dbContext.ProductSubCategory.FirstAsync(x => x.ProductSubCategoryId == ProductSubCategory.ProductSubCategoryId);
        ...
        public async void deleteSingleItem(long id)
        {
            ...
            try
            {
                ...
                ProductSubCategory = await _dbContext.ProductSubCategory.FirstAsync(x => x.ProductSubCategoryId == ProductSubCategory.ProductSubCategoryId);
